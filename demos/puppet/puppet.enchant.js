...
(function () {
	enchant.puppet = { assets: ['space3.png', 'icon0.gif', 'chara0.png', 'chara2.png', 'chara3.png', 'chara3.png','chara4.png','chara5.png', 'chara6.png', 'chara7.png','starship.png','enemy01.png','effect0.gif','eclipse.png','hollywood.png','desert.png','beach.png','sky.png','spacebg.png'] };
})();
...
enchant.Puppet.Behavior={
	...
	die:{
		enterframe:function(){this.die();}
	},
	bigger:{
		enterframe:function(){this.scaleX*=1.05;this.scaleY*=1.05;}
	},
	smaller:{
		enterframe:function(){this.scaleX*=0.95;this.scaleY*=0.95;}
	},
	moveRight:{
		enterframe:function(){this.x+=this.speed*0.1;}
	},
...
//		alert(this.appearInterval );
	...
	tapRC:{
		init:function(){this.a=0;this.dir=-Math.PI/2;},
		enterframe:function(){
