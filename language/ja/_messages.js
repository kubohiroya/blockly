...
Blockly.MSG_EXTERNAL_INPUTS = '外部入力';
Blockly.MSG_INLINE_INPUTS = 'インライン入力';
Blockly.MSG_DELETE_BLOCK = 'ブロックを削除';
Blockly.MSG_DELETE_X_BLOCKS = '%1 ブロックを削除';
Blockly.MSG_COLLAPSE_BLOCK = 'ブロックを閉じる';
Blockly.MSG_EXPAND_BLOCK = 'ブロックを開く';
Blockly.MSG_DISABLE_BLOCK = 'ブロックを無効化する';
Blockly.MSG_ENABLE_BLOCK = 'ブロックを有効化する';
...
Blockly.LANG_LISTS_INDEX_OF_TOOLTIP = 'リスト内の最初または末尾からの出現位置\n' +
    '存在しなければ0を返す';
Blockly.LANG_LISTS_INDEX_OF_FIRST = '先頭から';
Blockly.LANG_LISTS_INDEX_OF_LAST = '末尾から';
...
Blockly.LANG_LISTS_GET_INDEX_INPUT_AT = 'アイテムの読み出し';
Blockly.LANG_LISTS_GET_INDEX_INPUT_IN_LIST = 'リスト内';
Blockly.LANG_LISTS_GET_INDEX_TOOLTIP = 'リスト内の指定した位置の値を返す';
...
Blockly.LANG_LISTS_SET_INDEX_INPUT_AT = 'アイテムをセット';
Blockly.LANG_LISTS_SET_INDEX_INPUT_IN_LIST = 'リスト内';
Blockly.LANG_LISTS_SET_INDEX_INPUT_TO = '指定位置';
Blockly.LANG_LISTS_SET_INDEX_TOOLTIP = 'リスト内の指定した位置に値をセット';

// Variables Blocks.
Blockly.LANG_VARIABLES_GET_HELPURL = 'http://en.wikipedia.org/wiki/Variable_(computer_science)';
Blockly.LANG_VARIABLES_GET_TITLE = '取得';
Blockly.LANG_VARIABLES_GET_ITEM = 'アイテム';
Blockly.LANG_VARIABLES_GET_TOOLTIP = 'この変数の値を返す';

Blockly.LANG_VARIABLES_SET_HELPURL = 'http://en.wikipedia.org/wiki/Variable_(computer_science)';
Blockly.LANG_VARIABLES_SET_TITLE = 'セット';
Blockly.LANG_VARIABLES_SET_ITEM = 'アイテム';
Blockly.LANG_VARIABLES_SET_TOOLTIP = '変数に入力と同じ値をセット';

// Procedures Blocks.
Blockly.LANG_PROCEDURES_DEFNORETURN_HELPURL = 'http://en.wikipedia.org/wiki/Procedure_%28computer_science%29';
Blockly.LANG_PROCEDURES_DEFNORETURN_PROCEDURE = 'プロシジャ';
Blockly.LANG_PROCEDURES_DEFNORETURN_DO = '実行';
Blockly.LANG_PROCEDURES_DEFNORETURN_TOOLTIP = '値を返さないプロシジャ';
...
Blockly.LANG_PROCEDURES_DEFRETURN_RETURN = '値を返す';
Blockly.LANG_PROCEDURES_DEFRETURN_TOOLTIP = '値を返すプロシジャ';
...
Blockly.LANG_PROCEDURES_CALLNORETURN_CALL = '実行';
Blockly.LANG_PROCEDURES_CALLNORETURN_PROCEDURE = 'プロシジャ';
Blockly.LANG_PROCEDURES_CALLNORETURN_TOOLTIP = '値を返さないプロシジャの呼び出し';
...
Blockly.LANG_PROCEDURES_CALLRETURN_TOOLTIP = '値を返すプロシジャの呼び出し';

Blockly.LANG_PROCEDURES_MUTATORCONTAINER_TITLE = 'パラメータ';
Blockly.LANG_PROCEDURES_MUTATORARG_TITLE = '変数:';

Blockly.LANG_PROCEDURES_HIGHLIGHT_DEF = 'プロシジャのハイライト';

Blockly.LANG_PROCEDURES_IFRETURN_TOOLTIP = 'もし値が真ならば、値を返す';
Blockly.LANG_PROCEDURES_IFRETURN_WARNING = '警告:\n' +
    'このブロックはプロシジャの\n' +
    '内側でしか使えません';
